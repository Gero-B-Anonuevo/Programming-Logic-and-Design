        ...
        if first_name and last_name:
            ...
            if alpha_validation.isalpha():
                ...
                if num_validation.isdigit():
                    ...
                    print("Title: ", customer_title, "Age: ", customer_age, "  Nationality: ", customer_nationality)
                    ...
                    print("-------------------------------------------------------------------------------------------------------")
                    tk.messagebox.showinfo(title="Greetings!", message=("Hello! " + full_name_2 + ", " + good_citizen + ", you are currently " + customer_age + "  years old. From " + customer_nationality + ". You believe you are a " + rate_yourself + " with " + good_deeds + " good deeds. What a remarkable confidence done right. Because of that the Christmas Corps will ensure you receive a deserving gift from Claus himself!"))
                else:
